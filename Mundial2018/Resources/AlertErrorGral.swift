...
//
//            } else if funcion.contains("api/expediente") {
//                alertErrorResponse(targetVC: targetVC, title: "¡Atención!", message: "El expediente ya no puede ser eliminado.", detail_error:"\(data)")
//            } else {
